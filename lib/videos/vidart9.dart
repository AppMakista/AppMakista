...
class vidart9 extends StatefulWidget {
  @override
  _vidart9State createState() => _vidart9State();
}

class _vidart9State extends State<vidart9> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset("assets/videos/wozo.mp4")
      ..initialize().then((_) {
        setState(() {});
      });
