...
class vidart3 extends StatefulWidget {
  @override
  _vidart3State createState() => _vidart3State();
}

class _vidart3State extends State<vidart3> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset("assets/videos/sou.mp4")
      ..initialize().then((_) {
        setState(() {});
      });
