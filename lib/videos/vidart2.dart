...
class vidart2 extends StatefulWidget {
  @override
  _vidart2State createState() => _vidart2State();
}

class _vidart2State extends State<vidart2> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset("assets/videos/dmamou.mp4")
      ..initialize().then((_) {
        setState(() {});
      });
